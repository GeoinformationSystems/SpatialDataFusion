...
public class GMLParserTest {
	...
	public void readGMLFile_V21() throws ProcessException {
		readGML(new URILiteral(new File("D:/Programmierung/Testdaten/gml", "wfs100.xml").toURI()));	
	}
	
	@Ignore
	public void readGMLFile_V31() throws ProcessException {
		readGML(new URILiteral(new File("D:/Programmierung/Testdaten/gml", "wfs110.xml").toURI()));	
	}
	
	@Ignore
	public void readGMLFile_V32() throws ProcessException {
		readGML(new URILiteral(new File("D:/Programmierung/Testdaten/gml", "wfs20.xml").toURI()));	
	}
