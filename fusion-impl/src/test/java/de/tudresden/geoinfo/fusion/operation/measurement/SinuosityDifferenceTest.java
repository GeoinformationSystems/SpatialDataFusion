...
public class SinuosityDifferenceTest extends AbstractMeasurementTest {
    ...
    @Test
    public void getSinuosityDifference() {
        calculateDifference(
    ...
    public void calculateDifference(GTFeatureCollection domain, GTFeatureCollection range, DecimalLiteral threshold) {
