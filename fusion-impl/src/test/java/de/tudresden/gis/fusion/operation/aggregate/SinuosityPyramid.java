...
public class SinuosityPyramid {
	...
	public void test() throws FileNotFoundException{
		...
		input.put("IN_RESOURCE", new URILiteral(new File("D:/Geodaten/LfULG/Gewässerstrukturkartierung", "Gewaessernetz.shp").toURI()));
		Map<String,IData> output = parser.execute(input);		
		GTFeatureCollection reference = (GTFeatureCollection) output.get("OUT_FEATURES");
		GTFeature lockwitzbach = reference.elementById("Gewaessernetz.55");
