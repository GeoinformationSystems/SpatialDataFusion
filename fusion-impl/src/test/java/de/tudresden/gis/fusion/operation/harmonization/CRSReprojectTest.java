...
public class CRSReprojectTest {
	...
	public void reproject() throws ProcessException, FactoryException {
		...
		input.put("IN_RESOURCE", new URILiteral(new File("D:/GIS/Programmierung/testdata/OSM", "roads.shp").toURI()));
		...
		input.put("IN_REFERENCE_CRS", new URILiteral("CRS:84"));
		input.put("IN_TARGET", target);
		input.put("IN_TARGET_CRS", new URILiteral("http://www.opengis.net/def/crs/EPSG/0/31465"));
	...
	public void reprojectWithCRS() throws ProcessException, FactoryException {
		...
		CRSReproject process = new CRSReproject();
		input.put("IN_REFERENCE", reference);
		input.put("IN_REFERENCE_CRS", new URILiteral("http://www.opengis.net/def/crs/EPSG/0/31465"));
		input.put("IN_TARGET", target);
		input.put("IN_TARGET_CRS", new URILiteral("CRS:84"));
		input.put("IN_CRS", new URILiteral("http://www.opengis.net/def/crs/EPSG/0/4326"));
		output = process.execute(input);
