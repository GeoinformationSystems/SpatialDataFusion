...
public class WFSCapabilities extends OWSCapabilities {
	...
	private static final String WFS_LAYER = ".*(?i)AbstractFeatureType";
	 ...
	 * @throws IOException
	 */
	public WFSCapabilities(IIdentifier identifier, Document object, IMetadataForData description) throws ParserConfigurationException, SAXException, IOException {
