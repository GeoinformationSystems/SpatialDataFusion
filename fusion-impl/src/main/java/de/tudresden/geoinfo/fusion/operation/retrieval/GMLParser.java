...
public class GMLParser extends AbstractOperation {
	...
	private static final IIdentifier PROCESS = new Identifier(GMLParser.class.getSimpleName());
	...
	private AbstractFeatureCollection<?> parseGML(URL resourceURL, InputStream stream, Configuration configuration, boolean withIndex) throws XMLStreamException, IOException, SAXException {
	    ...
	    while((feature = (SimpleFeature) gmlParser.parse()) != null) {        	
	    	...
	    	features.add(new GTVectorFeature(new Identifier(featureID), feature, null, null));
	    }
	...
	public Map<IIdentifier,IInputConnector> initInputConnectors() {
        ...
        inputConnectors.put(IN_RESOURCE, new InputConnector(
                IN_RESOURCE,
				new MetadataForConnector(IN_RESOURCE.toString(), "Link to input GML"),
				new IDataConstraint[]{
