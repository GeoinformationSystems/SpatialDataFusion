...
public class SinuosityDifference extends AbstractRelationMeasurement {
    ...
    private static final IIdentifier PROCESS = new Identifier(SinuosityDifference.class.getSimpleName());

    private final static IIdentifier IN_THRESHOLD = new Identifier("IN_THRESHOLD");

    private static final IResource MEASUREMENT_OPERATION = Operations.GEOMETRY_DIFFERENCE_SINUOSITY.getResource();
    ...
    public String getProcessTitle() {
        return "Sinuosity difference calculation";
    }

    @Override
    public String getProcessAbstract() {
        return "Calculates feature relation based on sinuosity difference";
    }
    ...
    public Map<IIdentifier,IInputConnector> initInputConnectors() {
        ...
        inputConnectors.put(IN_THRESHOLD, new InputConnector(
                IN_THRESHOLD,
                new MetadataForConnector(IN_THRESHOLD.toString(), "sinuosity difference threshold for creating a relation"),
                new IDataConstraint[]{
    ...
    protected String getMeasurementTitle() {
        return "sinuosity difference";
    }

    @Override
    protected String getMeasurementDescription() {
        return "sinuosity difference between linear geometries";
    }
    ...
    protected IMeasurementRange<Double> getMeasurementRange() {
        return DecimalLiteral.getRange(1, Double.MAX_VALUE);
    }
