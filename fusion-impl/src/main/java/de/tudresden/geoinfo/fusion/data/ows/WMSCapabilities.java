...
public class WMSCapabilities extends OWSCapabilities {
	 ...
	 * @throws IOException
	 */
	public WMSCapabilities(IIdentifier identifier, Document object, IMetadataForData description) throws ParserConfigurationException, SAXException, IOException {
