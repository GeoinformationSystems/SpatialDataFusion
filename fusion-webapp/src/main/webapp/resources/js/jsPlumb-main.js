...
/**
 * active processes used for workflow
 */
var activeProcesses = {};
...
function f_init() {
    ...
    var referenceDescription = {
        title: 'ReferenceWFS', identifier: 'ReferenceWFS', uuid: '0_ReferenceWFS',
        inputs: [],
        outputs: [{
            identifier: 'OUT_FEATURES', title: 'WFS GML output',
    ...
    var targetDescription = {
        title: 'TargetWFS', identifier: 'TargetWFS', uuid: '0_TargetWFS',
        inputs: [],
        outputs: [{
            identifier: 'OUT_FEATURES', title: 'WFS GML output',
            defaultFormat: {mimetype: 'text/xml', schema: 'http://schemas.opengis.net/gml/3.2.1/base/feature.xsd'},
...
//	f_initDemo();
    var outputDescription = {
        title: 'Output', identifier: 'Output', uuid: '0_Output',
        inputs: [{
            identifier: 'IN_OUTPUT', title: 'Output of the fusion process',
            defaultFormat: {mimetype: 'text/xml', schema: 'http://schemas.opengis.net/gml/3.2.1/base/feature.xsd'},
            supportedFormats: [{mimetype: 'text/xml', schema: 'http://schemas.opengis.net/gml/3.2.1/base/feature.xsd'},
                {mimetype: 'application/json'},
...
function f_initDemo() {
    ...
    var demo1 = {
        title: 'SimilarityMapping', identifier: 'SimilarityMapping', uuid: 'SimilarityMapping',
        inputs: [{
            identifier: 'IN_MEASUREMENTS', title: 'Measurements',
            defaultFormat: {mimetype: 'text/turtle'},
            supportedFormats: [{mimetype: 'text/turtle'}]
        }],
        outputs: [{
            identifier: 'OUT_RELATIONS', title: 'OUT_RELATIONS',
            defaultFormat: {mimetype: 'text/turtle'},
            supportedFormats: [{mimetype: 'text/turtle'}]
        }]
    };
    ...
    var demo2 = {
        title: 'BestCorrespondence', identifier: 'BestCorrespondence', uuid: 'BestCorrespondence',
        inputs: [{
            identifier: 'IN_RELATIONS', title: 'Relations',
            defaultFormat: {mimetype: 'text/turtle'},
            supportedFormats: [{mimetype: 'text/turtle'}]
        },
            {
    ...
    var demo3 = {
        title: 'FeatureTransfer', identifier: 'FeatureTransfer', uuid: 'FeatureTransfer',
        inputs: [{
            identifier: 'IN_RELATIONS', title: 'Relations',
            defaultFormat: {mimetype: 'text/turtle'},
            supportedFormats: [{mimetype: 'text/turtle'}]
    ...
    var demo4 = {
        title: 'AttributeTransfer', identifier: 'AttributeTransfer', uuid: 'AttributeTransfer',
        inputs: [{
            identifier: 'IN_RELATIONS', title: 'Relations',
            defaultFormat: {mimetype: 'text/turtle'},
            supportedFormats: [{mimetype: 'text/turtle'}]
